// URL where games.json is hosted — change this to your live domain
// e.g. 'https://rbxlab.st/games.json'  or  'https://yourdomain.com/games.json'
var GAMES_URL = 'http://localhost:5501/games.json';
